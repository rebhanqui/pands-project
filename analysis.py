...
plt.gcf().set_size_inches(10, 8)
sns.scatterplot(x="petal_width", y="sepal_width", hue="species", data=data)
plt.legend(bbox_to_anchor=(1, 1), loc=2)
...
plt.gcf().set_size_inches(10, 8)
sns.scatterplot(x="petal_width", y="sepal_length", hue="species", data=data)
plt.legend(bbox_to_anchor=(1, 1), loc=2)
...
plt.gcf().set_size_inches(10, 8)
sns.scatterplot(x="sepal_width", y="petal_length", hue="species", data=data)
plt.legend(bbox_to_anchor=(1, 1), loc=2)
